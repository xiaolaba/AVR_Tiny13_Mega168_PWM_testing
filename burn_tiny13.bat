...
REM internal RC 9.6MHZ fuse setting
set mcu=attiny13
set lfuse=0x7a
set hfuse=0xff
set F_CPU=1200000
...
set main=main
set target=%dir%\avr_RF_LED_detector
...
avrdude -c usbtiny -p %mcu% -U flash:w:Blink_using_Timer0.ino_attiny13a_9600000L.hex:a
